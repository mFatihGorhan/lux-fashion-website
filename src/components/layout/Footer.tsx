          ...
          <div className={styles.footerGrid}>
            ...
            <div className={styles.brandColumn}>
              ...
              <p className={styles.brandDescription}>
                Ulaşılabilir lüks segmentinde, özgün ve sınırlı sayıda üretilen 
                koleksiyonlarımızla kadın giyiminde fark yaratıyoruz.
              </p>
            ...
            <div className={styles.contactColumn}>
              ...
              <div className={styles.contactItem}>
                ...
                <div>
                  <a href="tel:+905555555555" className={styles.contactLink}>
                    +90 555 555 55 55
                  </a>
              ...
              <div className={styles.contactItem}>
                ...
                <div>
                  <a href="mailto:info@luxefashion.com" className={styles.contactLink}>
        ...
        <div className={styles.container}>
          <div className={styles.bottomContent}>
            <p className={styles.copyright}>
              © {currentYear} Luxe Fashion. Tüm hakları saklıdır.
            </p>
